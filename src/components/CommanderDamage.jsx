...
{biohazard0 ?  <img onClick={BioHazardSetting0} style={{width:"35px",height:"35px"}} src={comDamageDone}></img> :<img onClick={BioHazardSetting0} style={{width:"35px",height:"35px"}} src={comDamage}></img>}
