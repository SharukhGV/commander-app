...
{biohazard0 ?  <img onClick={BioHazardSetting0} style={{width:"50px",height:"50px"}} src={comDamageDone}></img> :<img onClick={BioHazardSetting0} style={{width:"50px",height:"50px"}} src={comDamage}></img>}
